...
from PyQt5.QtPrintSupport import QPrintDialog, QPageSetupDialog
from src.dialogs.GoToDialog import GoToDialog
from src.dialogs.FindDialog import FindDialog
from src.gui.main_window_gui_creation import main_create_gui, main_create_status_bar, main_create_toolbar, \
    main_create_menu_bar
...
class TextEditMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        main_create_status_bar(self)
        main_create_toolbar(self)
        main_create_menu_bar(self)
